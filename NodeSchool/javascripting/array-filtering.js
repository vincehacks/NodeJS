...
*****************************************************************************
  ...
  There are many ways to manipulate arrays. One common task is filtering
  arrays to only contain certain values. For this we can use .filter()
  ...
  numbers.filter(). The function that you pass to the .filter() method will
