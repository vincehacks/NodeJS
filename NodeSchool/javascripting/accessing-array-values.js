 ...
 ******************************************************************************
  ...
  Array elements can be accessed through index number. Index number starts
  from zero to array's property length minus one.
  ...
  Array elements must be accessed through only using bracket notation. Dot
  notation is invalid.
