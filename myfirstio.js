 ...
 ****************************************************************************/
  ...
  // Acquire the file system module and use it to load the file into a buffer
  var fs = require('fs');
  var buffer = fs.readFileSync(process.argv[2]);

  // Convert the buffer to readable string and split each new line in an array
  var str = buffer.toString();
  var stringArr = str.split('\n');

  // Print the array and the number of elements
  //console.log(stringArr);
  console.log(stringArr.length-1);

  // Test output
  // [ 'vince', 'chang', 'atl', 'ale', '' ] it automatically puts an extra ' '
  // 4